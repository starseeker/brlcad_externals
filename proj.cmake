...
if (ENABLE_ALL AND NOT DEFINED ENABLE_PROJ)
  set(ENABLE_PROJ ON)
endif (ENABLE_ALL AND NOT DEFINED ENABLE_PROJ)
...
if (ENABLE_PROJ)
  ...
  if (TARGET SQLITE3_BLD)
    ...
    set(SQLite3_EXECNAME ${CMAKE_INSTALL_PREFIX}/${BIN_DIR}/sqlite3${CMAKE_EXECUTABLE_SUFFIX})
  ...
  ExternalProject_Add(PROJ_BLD
    ...
    -DSQLite3_ROOT=$<$<BOOL:${SQLITE3_TARGET}>:${CMAKE_INSTALL_PREFIX}>
