...
static const char *cpuClassName[CPUINFO_CLASS_COUNT] =
{
 ...
 [CPUINFO_CLASS_K6] = "K6",
 [CPUINFO_CLASS_COREI7AVX2] = "COREI7-AVX2",
 [CPUINFO_CLASS_COREI7AVX] = "COREI7-AVX",
...
{
  fprintf( file, "#ifndef CPUCONFIG_H\n" );
  fprintf( file, "#define CPUCONFIG_H\n" );
  fprintf( file, "\n" );
...
static void cpuFindCcOptions( cpuInfo *cpu, char *cctarget, char *ccoptions )
{
  ...
  sprintf( cpu->cctarget, "WARNING, Unknown Compiler" );
  sprintf( cpu->ccoptions, "" );
